...
module Categories.SemiBicategory where
...
open import Categories.SemiEnriched.Category using () renaming (Category to SemiEnriched)
...
record SemiBicategory o ℓ e t : Set (suc (o ⊔ ℓ ⊔ e ⊔ t)) where
  field
    enriched : SemiEnriched (Product.Cats-Monoidal {o} {ℓ} {e}) t

  open SemiEnriched enriched public
